...
const BostonPage = ({ pageContext, location }) => {
  const data = useStaticQuery(graphql`
    query BostonPageQ {
      headerBgImg: file(
        relativePath: {
          eq: "assets/images/massachusetts/boston/we-buy-junk-cars-boston-ma-angels-towing-junk-car-mass.jpg"
        }
      ) {
        childImageSharp {
      ...
      imgContentTop: file(
        relativePath: {
          eq: "assets/images/massachusetts/boston/cash-for-junk-cars-boston-ma-angels-towing-junk-car-mass.jpg"
        }
      ) {
        childImageSharp {
          fluid(quality: 90, maxWidth: 1920) {
  ...
  return (
    <>
      <SEO
        title={`Cash For Junk Cars Boston, MA - Junk Car Removal | ${siteMetadata.title}`}
        description={`In Boston, we pay the most cash for junk cars & offer same day pickup. Free towing & no hidden fees. Call ${phone.phoneDisplay} for your junk car removal`}
        canonicalLink="https://junkcarsmass.com/massachusetts/boston/"
      />
      <Header
        Tag="header"
      ...
      <Body
        bodyContent={
          <BodyContent>
            <Container>
              <h2 className="mb-3">
                Junk Car Removal Services For Boston Residents
              </h2>
              ...
              <p className="mt-5">
                ...
                in your driveway or taking up your only parking space on a
                Boston street? Wouldn't it be nice if a team of licensed junk
                car experts drove directly to the Bean, towed your car away, AND
                gave you <strong>cash in hand all on the same day</strong>​?
              </p>
              <p>​Luckily, this process is easier than you think!</p>
              <p>
                Angels Towing - Junk Car Mass is an{' '}
                <strong>experienced team of Boston junk car buyers</strong> that
                can help you get one step closer to finally freeing up some
                space at home, providing financial relief towards a new vehicle,
                or simply just having some extra cash in your pocket for the
                next Boston Red Sox home game at Fenway Park.​
              </p>
              ...
              <h2 className="pt-4 my-5">
                Sell Your Junk Car In Boston Before Repairs Cost You More
              </h2>
              <p>
                Your vehicle has been through a lot — memorable family
                vacations, countless road trips, exhausting work commutes over
                the Zakim Bridge... we get it, your car is a significant part of
                your life. But keep in mind, older vehicles depreciate quickly
              ...
              <p>
                ...
                worse time possible (like in the HOV lane on I-93). Next thing
                you know, you need a few{' '}
              ...
              />
              <p>
                So what happens if you drive your car day in and day out through
                Boston's Central Artery? Well, it will certainly{' '}
                <strong>lose value and limit the cash offer</strong> when
                selling your junk car.
              </p>
              <h2 className="pt-4 my-5">
                We Buy Boston Junk Cars For The Most Cash
              </h2>
              <p>
                ​We get calls all the time from people that are VERY unhappy
                with the quote they received from other junk car companies
                throughout Suffolk County. The market is saturated and some of
                them just aren't looking out for your best interest.​ Here at
                Angels Towing - Junk Car Mass, we take pride in our business and
                look forward to helping out Bostonians with a{' '}
                <strong>high cash offer you can't refuse</strong>!​​
              </p>
              <p>
              ...
              />
              <h2 className="pt-4 my-5">
                See What Our Boston Customers Have To Say About Angels Towing -
                Junk Car Mass
              </h2>
              <p>
              ...
              <p>
                ...
                trucks will be on I-93 North ready to{' '}
              ...
              <p>
                ...
                service your Boston neighborhood? ​Do you need more information
                about our services?
              </p>
              <p>
